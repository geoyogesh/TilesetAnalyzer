...
from tileset_analyzer.entities.job_param import CompressionType, JobAction, JobParam, TileScheme
...
def cli():
    ...
    parser.add_argument(
        "--compressed", help="compressed", default=False, action=argparse.BooleanOptionalAction
    )
    ...
    parser.add_argument(
        "--mbtiles_tbl",
        help="mbtiles tbl params",
        default="tiles,tile_row,tile_column,zoom_level,tile_data",
    )
