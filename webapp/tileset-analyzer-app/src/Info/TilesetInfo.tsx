...
const TileSetInfo: FC = () => {
  ...
  const {
    ...
    paginationProps,
    propertyFilterProps,
  } = useCollection(tableData === null ? [] : tableData, {
    propertyFiltering: {
  ...
  return (
    <ContentLayout header={<Header variant="h1">Tileset Info</Header>}>
      <SpaceBetween size="m">
        <Container>
          {tilesetInfo !== null ? (
        ...
        <Container header={<Header variant="h2">Explore Attributes</Header>}>
          ...
          >
            {currentRecord != null ? (
              <LayerInfo layer={currentRecord.layer_info_item}></LayerInfo>
            ) : (
              <Spinner />
            )}
          </Modal>
