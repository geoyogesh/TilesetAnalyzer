...
_TILE_GEOMTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(name="POINT", index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name="LINESTRING", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(name="POLYGON", index=3, number=3, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="SPLINE", index=4, number=4, options=None, type=None),
    ],
...
_TILE_SCALING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="offset",
            full_name="vector_tile.Tile.Scaling.offset",
            index=0,
            number=1,
            type=18,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="multiplier",
            full_name="vector_tile.Tile.Scaling.multiplier",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="base",
            full_name="vector_tile.Tile.Scaling.base",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
_TILE_FEATURE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="attributes",
            full_name="vector_tile.Tile.Feature.attributes",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="geometric_attributes",
            full_name="vector_tile.Tile.Feature.geometric_attributes",
            index=5,
            number=6,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="elevation",
            full_name="vector_tile.Tile.Feature.elevation",
            index=6,
            number=7,
            type=17,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="spline_knots",
            full_name="vector_tile.Tile.Feature.spline_knots",
            index=7,
            number=8,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="spline_degree",
            full_name="vector_tile.Tile.Feature.spline_degree",
            index=8,
            number=9,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="string_id",
            full_name="vector_tile.Tile.Feature.string_id",
            index=9,
            number=10,
            type=9,
            cpp_type=9,
...
_TILE_LAYER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="string_values",
            full_name="vector_tile.Tile.Layer.string_values",
            index=6,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="float_values",
            full_name="vector_tile.Tile.Layer.float_values",
            index=7,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="double_values",
            full_name="vector_tile.Tile.Layer.double_values",
            index=8,
            number=8,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="int_values",
            full_name="vector_tile.Tile.Layer.int_values",
            index=9,
            number=9,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="elevation_scaling",
            full_name="vector_tile.Tile.Layer.elevation_scaling",
            index=10,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="attribute_scalings",
            full_name="vector_tile.Tile.Layer.attribute_scalings",
            index=11,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tile_x",
            full_name="vector_tile.Tile.Layer.tile_x",
            index=12,
            number=12,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="tile_y",
            full_name="vector_tile.Tile.Layer.tile_y",
            index=13,
            number=13,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="tile_zoom",
            full_name="vector_tile.Tile.Layer.tile_zoom",
            index=14,
            number=14,
            type=13,
            cpp_type=3,
...
Tile = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        Scaling=_reflection.GeneratedProtocolMessageType(
            "Scaling",
            (_message.Message,),
            dict(
...
_TILE_FEATURE.fields_by_name["attributes"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TILE_FEATURE.fields_by_name["geometric_attributes"].has_options = True
_TILE_FEATURE.fields_by_name["geometric_attributes"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TILE_FEATURE.fields_by_name["elevation"].has_options = True
_TILE_FEATURE.fields_by_name["elevation"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TILE_FEATURE.fields_by_name["spline_knots"].has_options = True
_TILE_FEATURE.fields_by_name["spline_knots"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TILE_LAYER.fields_by_name["float_values"].has_options = True
_TILE_LAYER.fields_by_name["float_values"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TILE_LAYER.fields_by_name["double_values"].has_options = True
_TILE_LAYER.fields_by_name["double_values"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TILE_LAYER.fields_by_name["int_values"].has_options = True
_TILE_LAYER.fields_by_name["int_values"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
